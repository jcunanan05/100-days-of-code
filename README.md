...
* [Rules](rules.md)
* [Log - click here to see my progress](logs/r4-log.md)
* [FAQ](FAQ.md)
...
1.  Fork this repo and commit to the [Log](logs/log.md) or to the Alternative, rapid [R1 Log](logs/r1-log.md) (R1 stands for Round 1) daily. [Example](https://github.com/Kallaway/100-days-kallaway-log).
